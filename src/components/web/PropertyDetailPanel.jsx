...
export function PropertyDetailPanel({ property, onClose, onEdit, onDelete }) {
  ...
  if (!property) {
    return (
      <div className="w-96 bg-gradient-to-b from-amber-100 to-amber-50 border-l-4 border-amber-700 p-6 flex items-center justify-center">
        <p className="text-amber-900 text-center">매물을 선택하면 상세정보가 표시됩니다</p>
      </div>
    );
  }
      ...
      <div className="maple-frame">
        ...
        <div className="p-4 space-y-4">
          ...
          {property.rentalStatus && (
            <div className="bg-white/10 p-3 rounded">
              <h4 className="font-bold text-amber-300 mb-3">🏪 임대현황</h4>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
